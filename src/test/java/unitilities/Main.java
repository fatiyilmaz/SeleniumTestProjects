...
//===============Explicit Wait==============//
    public static WebElement waitForVisibility(WebElement element, int timeout) {//buton element su kadar bekle
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        return wait.until(ExpectedConditions.visibilityOf(element));
    }
    public static WebElement waitForVisibility(By locator, int timeout) {//bir locator icin su kadar bekle
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
    ...
    //COK KULLANILMAZ
    public static void clickWithTimeOut(WebElement element, int timeout) {//bir elemanin tiklanabilirligini hard wait yapiyoruz
    ...
    public static void waitForPageToLoad(long timeout) {//html tamamen dolana kadar bekle
